...
draw.rectangle([book_position, (book_position[0] + book_width, book_position[1] + book_height)], fill=text_color)

# Draw line chart symbol
chart_width = 150
chart_height = 150
chart_position = (logo_width // 2 - chart_width // 2, logo_height // 2 - chart_height // 2)
draw.rectangle([chart_position, (chart_position[0] + chart_width, chart_position[1] + chart_height)], fill=text_color)
...
draw.text(title_position, club_name, font=title_font, fill=background_color)
draw.text(subtitle_position, subtitle, font=subtitle_font, fill=background_color)
